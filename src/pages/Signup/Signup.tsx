...
export default function SignUp() {
  ...
  return (
    <main className="w-full min-h-[50vh] p-2 h-auto">
      <section className="w-full border-[1px] border-primary bg-light_gray max-w-7xl py-5 px-8 lg:px-16 my-5 rounded-[3rem] md:mx-auto md:flex md:gap-2 md:px-4 lg:items-center md:justify-between min-h-[50vh] h-[100%]">
        ...
        <div className="flex flex-col gap-4 mb-5 h-[100%] w-[100%] md:w-[50%] items-center justify-center md:bg-white">
          <Tabs value="html">
            <TabsHeader indicatorProps={{ id: "tabs-header-indicator" }}>
