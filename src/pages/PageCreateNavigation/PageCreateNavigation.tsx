...
export default function PageCreateNavigation() {
  return (
    <main className="w-full min-h-[50vh] p-2 h-auto">
      <section className="w-full border-[1px] py-8 border-primary bg-light_gray max-w-7xl px-8 lg:px-0 my-5 rounded-[3rem] md:mx-auto flex flex-col md:gap-2 md:px-0  min-h-[50vh] lg:min-h-[80vh] h-[100%] items-center lg:justify-center">
        <img
          src={"/static/images/Logo_BG.svg"}
          alt="logo"
          className="w-[4rem] lg:w-[6rem] mb-6"
        />
        <div className="flex flex-col md:flex-row gap-3 px-5 max-w-[60rem] lg:mb-10">
          <Card
            className="mt-6 w-[100%] md:w-1/3 justify-between py-8"
