...
export default function AgencyAwardCard({
  ...
  return (
    <div className="flex flex-col h-auto sm:h-[32rem] md:h-auto w-full pt-6 p-4 border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700 md:w-[95%] drop-shadow-md">
