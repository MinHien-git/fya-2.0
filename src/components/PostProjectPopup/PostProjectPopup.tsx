...
function StepOne({ moveNext }: IStep) {
  return (
    <>
      <div className="bg-white w-[80%] flex flex-col justify-start items-center pt-12 pb-6 px-4 rounded-2xl gap-4 h-auto max-h-[50rem] max-w-[22rem]">
        <img
...
function StepTwo({ moveNext, movePrevious }: IStep) {
  return (
    <>
      <div className="bg-white w-[80%] flex flex-col justify-start items-start pt-12 pb-6 px-4 rounded-2xl gap-4 h-auto max-h-[50rem] max-w-[22rem]">
