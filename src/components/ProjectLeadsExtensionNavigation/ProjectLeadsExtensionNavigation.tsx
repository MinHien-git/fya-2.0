export default function ProjectLeadsExtensionNavigation() {
  return (
    <div className="w-full">
      ...
      <ul className="flex justify-center items-center h-[3rem] border-b-2 w-full">
        <li className="w-1/3 text-center border-r-2">Applied</li>
        <li className="w-1/3 text-center border-r-2">Introduction sent</li>
        <li className="w-1/3 text-center border-r-2">Offer sent</li>
      </ul>
    </div>
  );
}
