...
import { GetAgencyProposalDetail } from "../../api/lib/proposal";
    ...
    <div className="w-[100vw] h-[100vh] bg-blue-gray-500/50 absolute top-0 left-0 flex justify-center items-center z-[1000]">
      <div className="bg-white shadow-lg rounded-2xl min-w-[70rem] flex flex-col items-center py-10 max-w-[72rem] relative h-[80vh] max-h-[60rem]">
        ...
        <div className="flex w-fit justify-center py-2 gap-4 mt-auto">
          <Button
            placeholder={undefined}
            className="flex bg-red-300 text-red-700 min-w-[8rem] items-center justify-center w-fit"
            size="lg"
          >
            Reject proposal
          </Button>
          <Button
            placeholder={undefined}
            className="flex text-tertiary min-w-[8rem] items-center justify-center bg-primary w-fit"
            size="lg"
          >
            Accept proposal
          </Button>
