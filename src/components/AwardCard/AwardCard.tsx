...
export default function AwardCard({ isEmpty, award_data, id }: IEditCard) {
  ...
  return empty ? (
    ...
    <Reorder.Item
      ...
      className="font-sans flex border-2 rounded-[10px] w-full py-6 px-8  h-[6.25rem] items-center shadow-md shadow-primary-500/20 bg-white"
    >
